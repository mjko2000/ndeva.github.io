...
//        dd($orders);
    ...
    public function listType(){
        ...
        return view('admin.list-type',compact('type'));
    }
    public function editType(Request $request, $id = null){
        if($request->isMethod('get')){
            ...
            $type->description = $request->desc;
            if($request->hasFile('img')){
                $file = $request->img;
                if ($type->image != $file->getClientOriginalName()) {
                    $file->move('source/image/product', $file->getClientOriginalName());
    ...
    public function addType(Request $request){
        ...
        //img
            ...
            return redirect()->back()->with('thongbao','Thêm type thành công');
        }
